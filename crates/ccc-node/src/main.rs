use ccc_command::CommandExecutor;
use ccc_core::{Config, Lifecycle, NodeIdentity, State};
use ccc_host::HostBridge;
use ccc_kafka::{SecureTransport, StdoutTransport, TopicNames, Transport};
use ccc_telemetry::TelemetryCollector;
use std::sync::Arc;
use tokio::sync::mpsc;
